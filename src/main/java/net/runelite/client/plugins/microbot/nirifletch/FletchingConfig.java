...
import net.runelite.client.plugins.microbot.nirifletch.enums.FletchingItem;
import net.runelite.client.plugins.microbot.nirifletch.enums.FletchingMaterial;
import net.runelite.client.plugins.microbot.nirifletch.enums.FletchingMode;

@ConfigGroup(FletchingConfig.GROUP)
public interface FletchingConfig extends Config {

    String GROUP = "NiriFletching";
